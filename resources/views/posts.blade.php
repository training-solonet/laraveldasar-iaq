                    ...
                    <div>
                        <div class="flex justify-between items-center mb-5 text-gray-500">
                            <a href="/categories/{{$post->category->slug}}">
                                <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:underline">
                                    {{ $post->category->name }}
                                </span>
                            </a>
                    ...
                    <div class="flex justify-between items-center mt-auto">
                        <a href="/authors/{{$post->author->username}}">
                            <div class="flex items-center space-x-3">
                                <img class="w-7 h-7 rounded-full" src="https://static.zerochan.net/Vestia.Zeta.full.3795988.jpg" alt="{{ $post->author->name }}" />
                                <span class="font-medium text-sm dark:text-white hover:underline">{{ $post->author->name }}</span>
                            </div>
                        </a>
